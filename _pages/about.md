...
- (Dec. 2025) We release [DDRL](https://research.nvidia.com/labs/dir/ddrl/), a data-regularized RL algorithm for diffusion! I use DDRL to post-train the NVIDIA [Cosmos-Predict2.5](https://research.nvidia.com/labs/dir/cosmos-predict2.5/) models (2B/14B) with ~2K H100 GPUs. Check our [post](https://x.com/haotian_yeee/status/1997138677529825452?s=20)!
